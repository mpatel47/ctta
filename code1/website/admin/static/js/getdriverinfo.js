...
fetch(url, {
    ...
    dataArray.forEach(item => {
      ...
      const editButton = document.createElement("button");
        ...
        editButton.addEventListener("click", () => {
          ...
          const popup = window.open("/admins/admin/editdriver/" + item.d_id, "Edit", `width=${width},height=${height},left=${left},top=${top}`);
        ...
        transferButton.addEventListener("click", () => {
          ...
          const popup = window.open("/admins/admin/transferdriver/" + item.d_id, "Transfer", `width=${width},height=${height},left=${left},top=${top}`);
  ...
  const popup = window.open("/admins/admin/adddriver/" + userId, "Edit", `width=${width},height=${height},left=${left},top=${top}`);
